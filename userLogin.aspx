...
<form id="form1" runat="server">
    ...
    <p><strong><font color="#006600">&gt; <a href="adminLogin.aspx">Administrative Login</a></font></strong></p>
        <p>
            <strong><font color="#006600">&gt;&gt; <a href="SantaHelpSponsor.aspx">Sponsor</a></font></strong></p>
        <p>
     ...
     <div id="Div1" style="position: absolute; left: 103px; top: 481px; width: 444px;
    ...
    <p>
        <font color="#990000" size="+3">User Login</font></p>
    ...
    .<br />Don&#39;t have a user account? Click
    <asp:Button ID="registerBtn" runat="server" Text="here" 
        onclick="registerBtn_Click" />
    &nbsp;to register.<br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><marquee><h1><asp:Label ID="scrollText" runat="server" Text="bamnf Santa Claus Parade"></asp:Label></h1></marquee>
     </form>
    <p>
        &nbsp;</p>
    <p>
