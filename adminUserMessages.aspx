<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminUserMessages.aspx.cs" Inherits="adminUserMessages" %>
...
<font color="#990000" size="+3">Administrator Area: 
    <asp:Label ID="orgOrUSer" runat="server" Text="View User Messages"></asp:Label></font></p>
<div id="Layer1" 
 ...
 <ul>
  ...
  <li><a href="#">Edit</a>
    ...
    <br />
    <br />
    <br /><h2>View User Messages:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="removeBlackList" runat="server" 
        Text=" Revome Black List "  CausesValidation="false" onclick="removeBlackList_Click"  
         />&nbsp; <asp:Button ID="messageUser" runat="server" 
        Text=" Message a User "  CausesValidation="false"  onclick="messageUser_Click"
         />

 </h2><br />
    <br /> &nbsp;<div style="position: absolute; left: 74px; top: 246px; z-index: 2; height: 332px;
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        DataSourceID="SqlDataSource1" ForeColor="#333333" Width="1587px" 
        ...
        <asp:BoundField DataField="messageID" HeaderText="Message ID" 
            ...
            <asp:BoundField DataField="messageDate" HeaderText="Message Date" 
                SortExpression="messageDate" />
            <asp:BoundField DataField="messageName" HeaderText="Message Name" 
                SortExpression="messageName" />
            <asp:BoundField DataField="messageDesc" HeaderText="Message Description" 
                SortExpression="messageDesc" />
              
                <asp:TemplateField HeaderText="">
                <itemtemplate>
                 <asp:Image ID="Image1" runat="server"  ImageUrl='<%# GetImageUrl(Eval("messageStatus") as string) %>' /> 
                </itemtemplate>
                </asp:TemplateField>
                <asp:ButtonField ButtonType="Image" CommandName="ReplyToMessage" HeaderText="Reply&nbsp;&nbsp;"
                ImageUrl="images/Letter.png" Text="More Information" />
                <asp:ButtonField ButtonType="Image" CommandName="BlackList" HeaderText="Black List"
                ImageUrl="images/blacklist.png" Text="Search" />
                <asp:ButtonField ButtonType="Image" CommandName="DeleteMessage" HeaderText="Delete&nbsp;&nbsp;"
                ImageUrl="images/delete_button25.png" Text="Search" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT messageID, userName, messageDate, messageName, messageDesc,messageStatus FROM messageFromUser">
    </asp:SqlDataSource>
    ...
    <div  style="position: absolute; left: 12px; top: 573px; z-index: 2; height: 280px;
        width: 370px;" id="orgTable" runat="server">
