<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reportGen.aspx.cs" Inherits="reportGen" %>
...
<body link="#006600" vlink="#990000" bgcolor="#ffff99">
    ...
    <font color="#990000" size="+3">Administrator Area: Generate List of Organizations</font></p>
    ...
    <asp:Panel ID="Panel1" runat="server" Height="365px" Width="812px">
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:pmsConnectionString %>"
            ProviderName="<%$ ConnectionStrings:pmsConnectionString.ProviderName %>" SelectCommand="SELECT oOrganization, oContact, oSeminarAtt, oPhone FROM orginfo">
        </asp:SqlDataSource>
          <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:pmsConnectionString %>"
            ProviderName="<%$ ConnectionStrings:pmsConnectionString.ProviderName %>" SelectCommand="SELECT paradeName FROM parade">
        </asp:SqlDataSource>
        <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="True"
            GroupTreeImagesFolderUrl="" Height="1202px" ReportSourceID="CrystalReportSource2"
            ToolbarImagesFolderUrl="" ToolPanelWidth="200px" Width="1104px" />
        <CR:CrystalReportSource ID="CrystalReportSource2" runat="server">
            <Report FileName="CrystalReport.rpt">
                <DataSources>
                    <CR:DataSourceRef DataSourceID="SqlDataSource1" TableName="orginfo" />
