<%@ Page Language="C#" AutoEventWireup="true" CodeFile="passwordManagement.aspx.cs" Inherits="passwordManagement" %>
...
<font color="#990000" size="+3">Administrator Area: Change Your Password</font></p>
<div id="Layer1" 
 ...
 <ul>
  ...
  <li><a href="#">Edit</a>
    ...
    <div  runat="server" style="position: absolute; left: 26px; top: 250px; z-index: 5; height: 285px;
        width: 965px;" >
     
        
        
        
        <table style="border: 5px solid green; width: 668px;"  border="1" 
            bgcolor="#999999">
        ...
        <tr>
            ...
            <tr>
             ...
             <tr>
                <td class="style2">
                    3 . Re-enter your new password :</td>
                <td>
                    <asp:TextBox ID="reNewPass" runat="server" TextMode="Password"></asp:TextBox>
                    <asp:CompareValidator ID="validatePasswordMatch" runat="server" 
                        ControlToCompare="newPass" ControlToValidate="reNewPass" 
            ...
            <tr>
             ...
             <tr>
                <td class="style2">
                    &nbsp;</td>
                <td>
                    <asp:Button ID="changePassword" runat="server" 
                        Text="  Change " onclick="changePassword_Click1"  
                        />
                </td>
                <td>
                    &nbsp;</td>
