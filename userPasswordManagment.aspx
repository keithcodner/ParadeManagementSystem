<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userPasswordManagment.aspx.cs" Inherits="userPasswordManagment" %>
...
<font color="#990000" size="+3">User Area: Change Your Password</font></p>
<div id="Layer1" 
 ...
 <ul>
    ...
    <div id="Div1"  runat="server" style="position: absolute; left: 26px; top: 250px; z-index: 5; height: 320px;
        ...
        <table style="border: 5px solid green; width: 656px;"  border="1" 
            bgcolor="#999999">
