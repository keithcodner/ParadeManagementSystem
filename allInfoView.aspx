<%@ Page Language="C#" AutoEventWireup="true" CodeFile="allInfoView.aspx.cs" Inherits="allInfoView" %>
...
<font color="#990000" size="+3">Administrator Area: 
    <asp:Label ID="orgOrUSer" runat="server" Text="More Info"></asp:Label></font></p>
<div id="Layer1" 
  ...
  <li><a href="#">Edit</a>
    ...
    <div style="position: absolute; left: 44px; top: 262px; z-index: 2; height: 175px;
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT uID, uUsername, uPassword, uFName, uLName, uHPhone, uBPhone, uCity, uStreet, uStatus, uEmail, uPostal, uProv, uDateJoined, uDateExpire, uActivation FROM user">
        </asp:SqlDataSource>
...
<asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
            ...
            ForeColor="Black" AllowPaging="True" PageSize="20" Width="1605px">
    <Columns>
