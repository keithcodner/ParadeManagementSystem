<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApprovedFloats.aspx.cs" Inherits="ApprovedFloats" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<body link="#006600" vlink="#990000" bgcolor="#ffff99">
    ...
    <font color="#990000" size="+3">Administrator Area: Generate List of Organizations</font>
    ...
    <br /><br />
   <br /><br /><br />
    Generate a report for the attendance of the organizations of the current parade 
    :
    <asp:Panel ID="Panel1" runat="server" Height="365px" Width="812px" 
        meta:resourcekey="Panel1Resource1">
         <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" 
            AutoDataBind="True" GroupTreeImagesFolderUrl="" 
    Height="1202px" ReportSourceID="ApprovedFloat" 
    ToolbarImagesFolderUrl="" ToolPanelWidth="200px" Width="1104px" 
     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:pmsConnectionString %>"
            ProviderName="<%$ ConnectionStrings:pmsConnectionString.ProviderName %>" SelectCommand="SELECT entryno, entryCode, entry, organization, floatWidth, floatHeight, floatLength FROM floatdetails ORDER BY entryNo ASC">
        </asp:SqlDataSource>
        ...
        <CR:CrystalReportSource ID="ApprovedFloat" runat="server">
            <report filename="RPTApprovedFloats.rpt">
             <DataSources>
                    <CR:DataSourceRef DataSourceID="SqlDataSource1" TableName="floatdetails" />
                    <CR:DataSourceRef DataSourceID="SqlDataSource2" TableName="pageconfig" />
