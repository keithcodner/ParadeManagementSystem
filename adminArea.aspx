...
<head runat="server"><link rel="shortcut icon" href="images/santaIcon.ico" />
    <title>Administrator Area: View Users</title>
...
<body link="#006600" vlink="#990000" bgcolor="#ffff99">
    ...
    <font color="#990000" size="+3">Administrator Area: User Details</font></p>
    ...
    <br />
    <br />
    All Parade Users:<asp:Label ID="test" runat="server" Text=""></asp:Label>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Panel ID="Panel1" runat="server" Height="163px">
        &nbsp;&nbsp;
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
            DataSourceID="userTable" ForeColor="#333333" AllowPaging="True" 
            ...
            <asp:BoundField DataField="uID" HeaderText="ID" 
                ...
                <asp:BoundField DataField="uBPhone" HeaderText="Bus. #&nbsp;&nbsp;&nbsp;&nbsp;"
                    SortExpression="uBPhone" />
                <asp:BoundField DataField="uStreet" HeaderText=" Address" 
                    SortExpression="uStreet" />
                <asp:BoundField DataField="uCity" HeaderText="City"
                    SortExpression="uCity" />
             ...
             <Columns>
             <asp:ButtonField ButtonType="Image" CommandName="moreInfo" HeaderText="More Information&nbsp;&nbsp;"
                ImageUrl="images/People.png" Text="More Information" />
                </Columns>
                  <Columns>
            <asp:ButtonField ButtonType="Image" CommandName="Search" HeaderText="Search&nbsp;&nbsp;"
        ...
        <asp:SqlDataSource ID="userTable" runat="server" ConnectionString="<%$ ConnectionStrings:pmsConnectionString %>"
            ProviderName="<%$ ConnectionStrings:pmsConnectionString.ProviderName %>" SelectCommand="SELECT uUsername, uOrgName, uFName, uLName, uHPhone, uBPhone, uStreet, uCity, uProv, uPostal, uEmail, uStatus, uActivation FROM user">
        </asp:SqlDataSource>
    </asp:Panel>
    <p>
        &nbsp;</p>
